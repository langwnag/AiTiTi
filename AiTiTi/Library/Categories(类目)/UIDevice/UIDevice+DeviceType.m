...
+(NSString *)platformString{
    ...
    //iPhone
    if ([UIApplication sharedApplication].keyWindow.bounds.size.width == 320 && [UIApplication sharedApplication].keyWindow.bounds.size.height == 480) {
        return @"iPhone 4s";
    }
    if ([UIApplication sharedApplication].keyWindow.bounds.size.width == 320 && [UIApplication sharedApplication].keyWindow.bounds.size.height == 568) {
        return @"iPhone 5s";
    }
    if ([UIApplication sharedApplication].keyWindow.bounds.size.width == 375 && [UIApplication sharedApplication].keyWindow.bounds.size.height == 667) {
        return @"iPhone 6";
    }
    if ([UIApplication sharedApplication].keyWindow.bounds.size.width == 414 && [UIApplication sharedApplication].keyWindow.bounds.size.height == 736) {
